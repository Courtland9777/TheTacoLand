...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "TacoLand - Order Ready for Pickup " + orderHeader.Id.ToString(), "Order is ready for pickup.");
        ...
        public async Task<IActionResult> OrderCancel(int OrderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "TacoLand - Order Cancelled " + orderHeader.Id.ToString(), "Order has been cancelled successfully.");
            ...
            if (searchName != null || searchEmail != null || searchPhone != null)
            {
                ...
                if (searchName != null)
                {
                    OrderHeaderList = await _db.OrderHeader.Include(o => o.ApplicationUser)
                                                .Where(u => u.PickupName.Contains(searchName, StringComparison.OrdinalIgnoreCase))
                ...
                else
                {
                    if (searchEmail != null)
                    {
                        user = await _db.ApplicationUser.Where(u => u.Email.Contains(searchEmail, StringComparison.OrdinalIgnoreCase)).FirstOrDefaultAsync();
                        OrderHeaderList = await _db.OrderHeader.Include(o => o.ApplicationUser)
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "TacoLand - Order Completed " + orderHeader.Id.ToString(), "Order has been completed successfully.");
